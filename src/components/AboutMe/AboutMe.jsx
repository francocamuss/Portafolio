    ...
    return(
        <div className="aboutMe-div" id="AboutMe">
            ...
            <div className="aboutMe-subDiv-1">
                ...
                <p>¡Bienvenido a mi portafolio web! Mi objetivo es mostrarte una variedad de trabajos que he realizado como programador web además de informacion sobre mi. Mis habilidades incluyen el diseño y desarrollo de sitios web, la integración de APIs y la optimización de motores de búsqueda. Espero que este portafolio te ayude a comprender la amplia gama de servicios que ofrezco como programador web y te dé la confianza para contactarme para tus proyectos futuros. ¡Gracias por la visita!</p>
